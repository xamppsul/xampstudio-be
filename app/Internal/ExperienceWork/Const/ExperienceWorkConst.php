...
namespace App\Internal\ExperienceWork\Const;

class ExperienceWorkConst
{
    const SUCCESSFULLY_LIST = "Berhasil Menampilkan ExperienceWork";
    const SUCCESSFULLY_CREATE = "Berhasil Menambahkan ExperienceWork";
    const SUCCESSFULLY_UPDATE = "Berhasil Mengubah ExperienceWork";
    const SUCCESSFULLY_DELETE = "Berhasil Menghapus ExperienceWork";
